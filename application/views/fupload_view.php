...
<?php
        ...
        <div class="accountArea">
			...
			<div class="account_btn blockLink" style="margin-top:10px"><a href="<? echo $this->config->item('base_url')."home/logout/"; ?>"><span>ログアウト</span></a></div>
        </div>
        </div>
