...
abstract class OAuth_Signature {
	 ...
	 */
	public function key(OAuth_Consumer $consumer, OAuth_Token2 $token = NULL)
	{
	...
	abstract public function sign(OAuth_Request $request, OAuth_Consumer $consumer, OAuth_Token2 $token = NULL);

	abstract public function verify($signature, OAuth_Request $request, OAuth_Consumer $consumer, OAuth_Token2 $token = NULL);
