...
class OAuth_Signature_HMAC_SHA1 extends OAuth_Signature {
	 ...
	 */
	public function sign(OAuth_Request $request, OAuth_Consumer $consumer, OAuth_Token2 $token = NULL)
	{
		// Get the signing key
	 ...
	 */
	public function verify($signature, OAuth_Request $request, OAuth_Consumer $consumer, OAuth_Token2 $token = NULL)
	{
